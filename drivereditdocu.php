	...
	elseif (time() - $_SESSION['login_time'] > 900) {
		...
		if (isset($_POST['btnDone'])) {
			if ($licensestat == 'Uploaded' && $crstat == 'Uploaded' && $orstat == 'Uploaded' && $nbistat == 'Uploaded') {
				echo '<script type="text/javascript">alert("All required documents are uploaded!");window.location.href = "https://betacars-webportal.000webhostapp.com/driverviewdocu.php";</script>';
				$_SESSION['login_time'] = time();
			}else{
				echo '<script type="text/javascript">alert("You have not uploaded all the required documents, please go back to Edit Documents and double check!");window.location.href = "https://betacars-webportal.000webhostapp.com/driverviewdocu.php";</script>';
				$_SESSION['login_time'] = time();
			}
			...
			if (unlink($linkL)) {
				...
				echo '<script type="text/javascript">alert("File delete error!");window.location.href = "https://betacars-webportal.000webhostapp.com/drivereditdocu.php";</script>';
				$_SESSION['login_time'] = time();
			}
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="ti-pencil-alt"></i><a href="#">Edit Documents</a></li>
                        </ul>
                    </li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Driver Dashboard / Account / Edit Documents</li>
                        </ol>
                    </div>
                </div>
            </div>
	...
	<script src="assets_driverdashboard/js/validate_editdocu.js"></script>
