                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Driver Dashboard / Account / View Profile</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body card-block">
  						<div class="row form-group">
							<div class="col col-md-6">
								...
								<input type="text" id="fname" name="fname" placeholder="<?php echo $fname ?>" disabled="" class="form-control">
							</div>
							<div class="col col-md-6">
								<label for="lname" class=" form-control-label">Last Name</label>
								<input type="text" id="lname" name="lname" placeholder="<?php echo $lname ?>" disabled="" class="form-control">
							</div>
						</div>
						<div class="row form-group">
							<div class="col col-md-6">
								<label for="email" class=" form-control-label">Email Address</label>
								<input type="text" id="email" name="email" placeholder="<?php echo $email ?>" disabled="" class="form-control">
							</div>
							<div class="col col-md-6">
								<label for="mobile" class=" form-control-label">Mobile Number</label>
								<input type="text" id="mobile" name="mobile" placeholder="<?php echo $mobile ?>" disabled="" class="form-control">
							</div>
						</div>
                    </div>
                    <div class="card-footer">
						<a href="driveredituser.php"><button type="button" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i>&nbsp;Edit My Info</button></a>
						<a href="drivereditpassword.php"><button type="button" class="btn btn-outline-success btn-sm"><i class="fa fa-exchange"></i>&nbsp;Change Password</button></a>
                    </div>
                </div>
				</form>
            </div>
