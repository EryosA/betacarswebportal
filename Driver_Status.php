...
<body>
  ...
  <br/>
  <div class="card">
    <h1 class="h151">Add Driver Status</h1>

    <form class="add_driver" action="assets/php/DriverStatus.php" method="POST">
      <div class="input-group">
        <input type="text" name="status" class="m-input" placeholder="Status" required>
        <!--<label for="first">Field 1</label>-->
      </div>
      <div class="input-group">
        <input type="text" name="pos_lat" class="m-input" placeholder="Latitude">
        <!--<label for="last">Field 2</label>-->
      </div>
      <div class="input-group">
        <input type="text" name="pos_lng" class="m-input" placeholder="Longhitude">
