                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Driver Dashboard / Account / View License Info</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body card-block">
						<div class="row form-group">
							<div class="col col-md-4">
								...
								<input type="text" id="license_no" name="license_no" value="<?php echo $license_no ?>" disabled="" class="form-control">
							</div>
							<div class="col col-md-4">
								<label for="license_ex" class=" form-control-label">License Expiration</label>
								<input type="date" id="license_ex" name="license_ex" value="<?php echo $license_ex ?>" disabled="" class="form-control">		
							</div>
						</div>
                    </div>
                    <div class="card-footer">
						<a href="drivereditlic.php"><button type="button" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i>&nbsp;Edit License Info</button></a>
                    </div>
                </div>
				</form>
            </div>
